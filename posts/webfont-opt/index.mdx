...
excerpt: 文字，對網頁的使用者體驗影響巨大，過大的字體檔會導致 CLS (Cumulative Layout Shift)，造成 FOUT (Flash Of Unstyled Text)，進而使瀏覽者迷失、閱讀中斷。這篇文章將帶你了解問題根本，並從根本出發提出網頁文字的最佳實踐。
publish_date: 2022/4/4
...
<RefsSection>
  <Ref
    text="Making Google Fonts Faster in 2022"
    link="https://sia.codes/posts/making-google-fonts-faster/"
  />
  <Ref
    text="Best practices for fonts"
    link="https://web.dev/font-best-practices/"
  />
  <Ref
    text="Optimize WebFont loading and rendering"
    link="https://web.dev/optimize-webfont-loading/"
  />
</RefsSection>
